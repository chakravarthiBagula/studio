...
import type { Team, TeamId } from '@/types/kabaddi';
...
function TeamSetupCard({ teamId, team, onAddPlayer, onRemovePlayer, onUpdateTeamName }: { teamId: TeamId, team: Team, onAddPlayer: (teamId: TeamId, playerName: string) => void, onRemovePlayer: (teamId: TeamId, playerId: string) => void, onUpdateTeamName: (teamId: TeamId, name: string) => void }) {
  ...
  return (
    <div className="space-y-8">
      <div className="grid md:grid-cols-2 gap-8">
        <TeamSetupCard teamId="teamA" team={teams.teamA} onAddPlayer={onAddPlayer} onRemovePlayer={onRemovePlayer} onUpdateTeamName={onUpdateTeamName} />
        <TeamSetupCard teamId="teamB" team={teams.teamB} onAddPlayer={onAddPlayer} onRemovePlayer={onRemovePlayer} onUpdateTeamName={onUpdateTeamName} />
      </div>
      <div className="flex justify-center">
        <Button size="lg" onClick={onStartMatch} disabled={!canStart}>
